...
export default function LegalCookiePolicy() {
    return (
        <article className="inner-container">
            <h1 className="text-h1-m sm:text-h1 mb-4 text-center">Cookie Policy</h1>
            ...
            <article className="mb-16">
                <h2 className="text-h5-m sm:text-h5 mb-8">What are Cookies?</h2>
                <p>
            ...
            <article className="mb-16">
                <h2 className="text-h5-m sm:text-h5 mb-8">How We&nbsp;Use Cookies</h2>
                <p className="mb-5">We&nbsp;use cookies for the following purposes:</p>
                <ol className="list-outside list-decimal pl-12">
                    <li className="mb-3">
                        <strong>Essential Cookies:</strong> These cookies are necessary for the operation of&nbsp;our
                    ...
                    <li className="mb-3">
                        <strong>Analytics Cookies:</strong> We&nbsp;use analytics cookies to&nbsp;collect information
            ...
            <article className="mb-16">
                <h2 className="text-h5-m sm:text-h5 mb-8">Your Cookie Choices</h2>
                <p>
            ...
            <article className="mb-16">
                <h2 className="text-h5-m sm:text-h5 mb-8">Managing Cookies</h2>
                <p>
            ...
            <article className="mb-16">
                <h2 className="text-h5-m sm:text-h5 mb-8">Updates to&nbsp;this Cookie Policy</h2>
                <p>
