...
export class ReactSlider extends React.Component {
    ...
    static propTypes = {
        ...
        // eslint-disable-next-line, zillow/react/no-unused-prop-types
    ...
    getValueFromPosition(position) {
        const diffValue =
            (position / (this.state.sliderLength - this.state.thumbSize)) * (this.props.max - this.props.min)
    ...
    moveUpByStep(step = this.props.step) {
        ...
        const newValue =
            this.props.invert && this.props.orientation === 'horizontal' ? oldValue - step : oldValue + step
