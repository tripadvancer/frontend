...
export const ButtonMinor = ({ children, variant, className, isLoading, isDisabled, onClick }: ButtonMinorProps) => {
    return (
        <button
            className={classNames(
                'hover-animated relative flex h-8 cursor-pointer items-center justify-center gap-x-2 px-6 text-small-bold enabled:hover:text-white disabled:cursor-no-drop disabled:opacity-30',
                {
