...
export const ButtonIcon = ({ children, isLoading, onClick }: ButtonIconProps) => {
    return (
        <div
            className="hover-animated flex h-10 w-10 cursor-pointer items-center justify-center rounded-lg border border-blue-20 text-blue-100 hover:border-blue-active hover:text-blue-active"
            onClick={onClick}
        >
            {isLoading ? (
                <svg
