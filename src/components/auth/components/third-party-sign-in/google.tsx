...
export const GoogleSignInUp = () => {
    ...
    const handleClick = async () => {
        ...
        try {
            const authUrl = await getAuthorisationURLWithQueryParamsAndSetState({
                ...
                frontendRedirectURI: `${process.env.NEXT_PUBLIC_WEBSITE_AUTH_CALLBACK_PATH}/google`,
            })
    ...
    return (
        <ButtonStroke className="mb-4 w-full" isLoading={isLoading} onClick={handleClick}>
