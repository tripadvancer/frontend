    ...
    return (
        <button
            ...
            className={classNames(
                'hover-animated flex-center relative h-10 whitespace-nowrap rounded-lg px-6 font-medium text-white focus:outline-none disabled:cursor-no-drop disabled:opacity-30',
                {
                    'bg-blue-100 enabled:hover:bg-blue-active': variant === 'blue',
                    'bg-orange-100 enabled:hover:bg-orange-active': variant === 'orange',
                    'bg-red-100 enabled:hover:bg-red-active': variant === 'red',
                },
                className,
            )}
