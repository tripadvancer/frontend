...
import { HeaderAddPlace } from './header-add-place'

export const HeaderAddPlaceWithAuth = async () => {
    ...
    if (!session) {
        if (!hasToken) {
             ...
             */
            return <HeaderAddPlace isAuth={false} />
        }
    ...
    return <HeaderAddPlace activeUserId={activeUserId} isAuth={true} isEmailVerified={isEmailVerified} />
}
