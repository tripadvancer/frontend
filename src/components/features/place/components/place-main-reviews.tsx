...
export const PlaceMainReviews = async ({ place, activeUserId, isAuth }: PlaceMainReviewsProps) => {
    ...
    return (
        <section className="flex scroll-m-24 flex-col gap-y-8 sm:scroll-m-28" id="reviews">
            ...
            <div className="flex flex-col gap-y-8">
                <PlaceMainOwnReview place={place} activeUserId={activeUserId} isAuth={isAuth} />
                <PlaceMainReviewsList placeId={place.id} activeUserId={activeUserId} isAuth={isAuth} />
            </div>
        </section>
    )
}
