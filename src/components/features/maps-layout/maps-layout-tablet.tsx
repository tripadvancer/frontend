...
export const MapsLayoutTablet = ({ header, map, widget, widgetRandom }: MapsLayoutTabletProps) => {
    ...
    useEffect(() => {
        const handleScroll = () => {
            ...
            const scrollPosition = window.innerHeight + (scrollContainerRef.current?.scrollTop || 0) - 47
            const scrollContainerHeight = containerRef.current?.clientHeight || 0
    ...
    return (
        <div className="size-full">
            ...
            <div className={classNames('block', { hidden: appMode === AppModes.MAP })}>
                ...
                >
                    <div ref={containerRef} className="pointer-events-auto rounded-2xl shadow-large">
