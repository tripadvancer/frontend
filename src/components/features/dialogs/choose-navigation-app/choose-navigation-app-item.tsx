...
export const ChooseNavigationAppItem = ({ lngLat, provider }: ChooseNavigationAppItemProps) => {
    return (
        <Link
            ...
            target="_blank"
        >
            <div className="flex-center hover-animated aspect-square rounded-2xl bg-orange-10 text-small hover:bg-orange-20">
                <Image
