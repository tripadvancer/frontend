import type { IUserStatistics } from '@/types/user'
...
export const UserAchievement = async ({ statistics }: UserAchievementProps) => {
    const t = await getScopedI18n('user.achievement')
        ...
        <AchievementBase
            ...
            body={
                <ul className="text-sm">
                    <AchievementItem label={t('statistic.added_places')} value={statistics.places} />
                    <AchievementItem label={t('statistic.added_photos')} value={statistics.placePhotos} />
                    <AchievementItem label={t('statistic.added_reviews')} value={statistics.placeReviews} />
                    <AchievementItem label={t('statistic.visited_places')} value={statistics.visitedPlaces} />
                </ul>
            }
        />
    )
