export default {
    ...
    'validation.location.invalid': 'Сoordinates must be in format: "lat, lng", e.g. "50.4501, 30.5234"',
    ...
    'complaint_reasons.abuse': 'Misuse, mistreatment or intentional harm',
    'complaint_reasons.copyright': 'Copyright or intellectual property rights violation',
    'complaint_reasons.duplicate': 'Duplicate, no additional value',
    'complaint_reasons.false': 'Incorrect or misleading information',
    'complaint_reasons.fraud': 'Fraudulent, deceptive activities',
    'complaint_reasons.inappropriate': 'Inappropriate or explicit content',
    'complaint_reasons.spam': 'Irrelevant or unsolicited content',
    'complaint_reasons.other': 'Other reason',
