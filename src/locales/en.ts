export default {
    ...
    'forms.validation.email.required': 'Please enter your email',
    'forms.validation.email.invalid': 'Please enter a valid email address',
    'forms.validation.password.required': 'Please enter your password',
    'forms.validation.password.min_length': 'Password must be at least {min_length} characters long',
    'forms.validation.password.max_length': 'The password must be at most {max_length} characters long',
    'forms.validation.username.required': 'Please enter your username',
