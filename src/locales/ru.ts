export default {
    ...
    'success.create_list': 'Список был успешно создан.',
    'success.update_list': 'Список был успешно обновлён.',
    'success.delete_list': 'Список был успешно удалён.',
    ...
    'widget.lists.empty_message': 'В этом списке нет мест.{br}Добавьте место в этот список, чтобы увидеть его здесь.',
    'widget.lists.add_button': 'Создать новый список',
    'widget.lists.info': 'Выберите список, чтобы увидеть сохранённые места.',
    'widget.lists.show_only_list': 'Показать на карте',
