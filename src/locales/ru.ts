export default {
    ...
    'complaint_reasons.abuse': 'Неправомерное использование, плохое обращение или умышленный вред',
    'complaint_reasons.copyright': 'Нарушение авторских или интеллектуальных прав',
    'complaint_reasons.duplicate': 'Дубликат, не добавляющий ценности',
    'complaint_reasons.false': 'Некорректная или вводящая в заблуждение информация',
    'complaint_reasons.fraud': 'Мошенничество, обман',
    'complaint_reasons.inappropriate': 'Неуместный или непристойный контент',
    'complaint_reasons.spam': 'Незначимый или нежелательный контент',
    'complaint_reasons.other': 'Другая причина',
