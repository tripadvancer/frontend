export default {
    ...
    'auth.change_password.submit': 'Сохранить',
    'auth.change_password.info': 'Создайте новый пароль длиной не менее 8 символов, содержащий сочетание букв и цифр:',
    'auth.change_password.success': 'Ваш пароль был успешно изменён.',
    'auth.change_password.forms.fields.old_password.placeholder': 'Введите Ваш текущий пароль',
    'auth.change_password.forms.fields.new_password.placeholder': 'Введите новый пароль',
    ...
    'auth.change_email.success': 'Мы отправили вам письмо с подтверждением. После подтверждения нового адреса электронной почты вы сможете войти в систему, используя его.',
    'auth.change_email.forms.fields.newEmail.placeholder': 'Введите новый email',
    'auth.change_email.forms.fields.password.placeholder': 'Введите Ваш пароль',
    ...
    'pages.user.settings.account.request_personal_data.confirm.title': 'Отправить персональные данные',
    'pages.user.settings.account.request_personal_data.confirm.message': 'Вы уверены, что хотите отправить копию своих персональных данных на Ваш email?',
    'pages.user.settings.account.request_personal_data.success': 'Мы отправили Вам письмо с копией Ваших персональных данных.',
    'pages.user.settings.account.request_user_removal': 'Удалить учётную запись',
    'pages.user.settings.account.request_user_removal.confirm.title': 'Удалить учётную запись',
    'pages.user.settings.account.request_user_removal.confirm.message': 'Вы уверены, что хотите удалить свою учётную запись?',
    'pages.user.settings.account.request_user_removal.success': 'Этот процесс может занять до нескольких дней. Вы можете восстановить свою учётную запись, используя ссылку, отправленную на Ваш email, до завершения процесса удаления.',
} as const
