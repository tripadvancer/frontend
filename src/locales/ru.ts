export default {
    ...
    'header.user_menu.my_profile': 'Мой профиль',
    ...
    'places_nearby_warning.message': 'Извините, добавление нового места в этой области невозможно, так как уже есть другие места в радиусе {distance} км. Если это существующее место, пожалуйста, поделитесь своим отзывом. В противном случае, обратитесь в нашу службу поддержки.',
