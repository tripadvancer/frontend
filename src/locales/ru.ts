export default {
    ...
    'onboarding.features.places.title': '{placesCount} мест в {countriesCount} странах{br}добвленных путешественниками',
    ...
    'pages.landing.around_places.title': 'Места рядом с Вами',
    'pages.landing.around_places.description': 'Посмотрите, что интересного есть рядом с Вами. Эти места рекомендуют другие путешественники и Вы можете посетить их уже сегодня.',
    'pages.landing.around_places.view_all': 'Посмотреть все места',
