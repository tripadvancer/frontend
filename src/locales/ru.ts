export default {
    ...
    'widget.random.error.not_location': 'Разрешите доступ к местоположению, чтобы найти случайное место поблизости, или установите свое местоположение вручную, кликнув на карте (или щелкнув правой кнопкой) и выбрав опцию "Я здесь".',
